...
export default function Hero() {
  return (
    <div
      class="w-full flex px-8 h-96 justify-center items-center flex-col gap-8 bg-cover bg-center bg-no-repeat bg-gray-100 text-white"
    ...
    >
      <div class="space-y-4 text-center">
        <h1 class="text-4xl inline-block font-bold">
          The tech netowrking <p class="bg-gradient-red-blue">community</p>
        </h1>
        <p class="text-xl max-w-lg text-blue-100">
          IT in Dublin is a community of tech professionals in Dublin, Ireland.
        </p>
      </div>
